...
using CleanArchitecture.Application.TodoItems.Queries.GetTodoItems;
...
public class TodoItemsController : ApiControllerBase
{
    ...
    [HttpGet]
    [Route("todo")]
    public async Task<ActionResult<List<TodoItemBriefDto>>> GetTodoItems([FromQuery] GetTodoItemsQuery query)
    {
        return await Mediator.Send(query);
    }
